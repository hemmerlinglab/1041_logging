...
while True:
    ...
    with open(path_room + current_date + '_chamber.log', 'a') as file_room, open(path_cryo + current_date + '_dewar.log', 'a') as file_cryo, open(path_rough + current_date + '_foreline.log', 'a') as file_rough, open(path_temp + current_date + '_temperature.log') as file_temp:
